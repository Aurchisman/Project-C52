class Game {
  ...
  start() {
    ...
    var obstacle1Positions = [
      { x: width / 2 - 150, y: height - 1300, image: cometImage },
      { x: width / 2 + 250, y: height - 1800, image: boulderImage },
      { x: width / 2 - 180, y: height - 3300, image: cometImage },
     
      { x: width / 2 - 150, y: height - 4300, image: boulderImage },
      { x: width / 2, y: height - 5300, image: cometImage },
    ];

    var obstacle2Positions = [
      { x: width / 2 + 250, y: height - 800, image: plutoImage },
      { x: width / 2 - 180, y: height - 2300, image: neptuneImage },
      { x: width / 2, y: height - 2800, image: uranusImage },
     
      { x: width / 2 + 180, y: height - 3300, image: saturnImage },
      { x: width / 2 + 250, y: height - 3800, image: jupiterImage },
      { x: width / 2 + 250, y: height - 4800, image: marsImage },
      { x: width / 2 - 180, y: height - 5500, image: earthImage }
    ];
